  ...
  if (submitted) {
    return (
      <div className="min-h-screen bg-white flex items-center justify-center px-6 pt-20">
        <div className="bg-white rounded-3xl border border-slate-100 shadow-hover p-12 max-w-md w-full text-center animate-fade-up">
          <div className="w-20 h-20 rounded-full bg-teal-100 flex items-center justify-center mx-auto mb-6 text-4xl animate-fade-in-scale">✓</div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl border border-slate-100 shadow-card p-8">
              {/* key triggers CSS re-animation on step change */}
